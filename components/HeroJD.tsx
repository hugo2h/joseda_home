...
// ─────────────────────────────────────────────────────────────────────────────
// HeroJD — vídeo cinematográfico + blur text reveal (Aristide / Apple style)
// ─────────────────────────────────────────────────────────────────────────────
export default function HeroJD() {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 1 — Fondo: zoom-out cinematográfico (scale 1.05 → 1, opacity 0 → 1)
      tl.from(bgWrapRef.current, {
        scale   : 1.05,
        opacity : 0,
        duration: 1.2,
        ease    : 'power2.out',
