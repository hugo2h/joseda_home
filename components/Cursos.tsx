...
// ─────────────────────────────────────────────────────────────────────────────
// Cursos — Horizontal Reveal (estilo Aristide Benoist)
// ─────────────────────────────────────────────────────────────────────────────
export default function Cursos() {
  ...
  return (
    <section ref={sectionRef} id="cursos" style={{ background: 'transparent', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            Aprende.<br /><em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>Transforma.</em>
          </h2>
        </div>
